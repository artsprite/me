...
class Tag extends \Mautic\LeadBundle\Entity\Tag implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Tag' . "\0" . 'id', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Tag' . "\0" . 'tag', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Tag' . "\0" . 'description', 'deletedId', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\Tag' . "\0" . 'uuid'];
        }

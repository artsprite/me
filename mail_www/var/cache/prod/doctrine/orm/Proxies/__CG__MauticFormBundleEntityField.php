...
class Field extends \Mautic\FormBundle\Entity\Field implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function isAutoFillReadOnly(): bool
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isAutoFillReadOnly', []);

        return parent::isAutoFillReadOnly();
    }
    ...
    public function setIsReadOnly(?bool $isReadOnly): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsReadOnly', [$isReadOnly]);

        parent::setIsReadOnly($isReadOnly);
    }

...
class Channel extends \Mautic\ChannelBundle\Entity\Channel implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mautic\\ChannelBundle\\Entity\\Channel' . "\0" . 'id', '' . "\0" . 'Mautic\\ChannelBundle\\Entity\\Channel' . "\0" . 'channel', '' . "\0" . 'Mautic\\ChannelBundle\\Entity\\Channel' . "\0" . 'channelId', '' . "\0" . 'Mautic\\ChannelBundle\\Entity\\Channel' . "\0" . 'channelName', '' . "\0" . 'Mautic\\ChannelBundle\\Entity\\Channel' . "\0" . 'message', '' . "\0" . 'Mautic\\ChannelBundle\\Entity\\Channel' . "\0" . 'properties', '' . "\0" . 'Mautic\\ChannelBundle\\Entity\\Channel' . "\0" . 'isEnabled', 'changes', 'pastChanges', '' . "\0" . 'Mautic\\ChannelBundle\\Entity\\Channel' . "\0" . 'uuid'];
        }

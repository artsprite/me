...
class LeadField extends \Mautic\LeadBundle\Entity\LeadField implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getIsCloned(): bool
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsCloned', []);

        return parent::getIsCloned();
    }
     ...
     * {@inheritDoc}
     */
    public function setIsShortVisible(?bool $isShortVisible): \Mautic\LeadBundle\Entity\LeadField
    {

...
class MauticSsoConfig 
{
     ...
     * @default false
     * @param ParamConfigurator|bool $value
     * @deprecated Option "require_previous_session" at "mautic_sso" is deprecated, it will be removed in version 7.0. Setting it has no effect anymore.
     * @return $this
     */
     ...
     * @return $this
     */
    public function integrationParameter($value): static
    {
        $this->_usedProperties['integrationParameter'] = true;
        $this->integrationParameter = $value;
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('integration_parameter', $value)) {
            $this->_usedProperties['integrationParameter'] = true;
            $this->integrationParameter = $value['integration_parameter'];
            unset($value['integration_parameter']);
        }
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['integrationParameter'])) {
            $output['integration_parameter'] = $this->integrationParameter;
        }

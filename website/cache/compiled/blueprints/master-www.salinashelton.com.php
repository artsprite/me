...
return [
    ...
    'timestamp' => 1752987375,
    'checksum' => 'a96c44fd2e89f15a74cc64e350793627',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/draft-preview' => [
                'file' => 'user/plugins/draft-preview/blueprints.yaml',
                'modified' => 1752065974
            ],
            'plugins/mautic' => [
                'file' => 'user/plugins/mautic/blueprints.yaml',
                'modified' => 1651738354
            ],
            'plugins/autoseo' => [
        ...
        'user/themes' => [
            'themes/delivernext' => [
                'file' => 'user/themes/delivernext/blueprints.yaml',
                'modified' => 1752983460
            ],
            'themes/quark' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.draft-preview.enabled' => [
                ...
                'name' => 'plugins.draft-preview.enabled',
                'validation' => 'loose'
            ],
            'plugins.draft-preview.route' => [
                'type' => 'text',
                'label' => 'PLUGIN_DRAFT_PREVIEW.ROUTE',
                'name' => 'plugins.draft-preview.route',
                'validation' => 'loose'
            ],
            'plugins.mautic' => [
                'type' => '_root',
            ...
            'plugins.mautic.enabled' => [
                ...
                'name' => 'plugins.mautic.enabled',
                'validation' => 'strict'
            ],
            'plugins.mautic.tracking' => [
                'type' => 'toggle',
            ...
            'plugins.autoseo.title' => [
                'type' => '_parent',
                'name' => 'plugins.autoseo.title',
                'form_field' => false
            ],
            'plugins.autoseo.title.append_site_title' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.autoseo.title.append_site_title',
                'validation' => 'strict'
            ],
            'plugins.autoseo.title.separator' => [
                'type' => 'text',
                ...
                'name' => 'plugins.autoseo.title.separator',
                'validation' => 'strict'
            ],
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'draft-preview' => [
                    'enabled' => 'plugins.draft-preview.enabled',
                    'route' => 'plugins.draft-preview.route'
                ],
                'mautic' => [
                    'enabled' => 'plugins.mautic.enabled',
                    'tracking' => 'plugins.mautic.tracking',
                    'url' => 'plugins.mautic.url'
                ],
                'autoseo' => [
                    'enabled' => 'plugins.autoseo.enabled',
                    'title' => [
                        'append_site_title' => 'plugins.autoseo.title.append_site_title',
                        'separator' => 'plugins.autoseo.title.separator'
                    ],
                    'description' => [
            ...
            'themes' => [
                'delivernext' => 'themes.delivernext',
                'quark' => [
